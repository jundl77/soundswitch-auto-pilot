...
MIDI_MSG_PAUSE_TOGGLE = [NOTE_ON, MIDI_PLAY_PAUSE_CHANNEL, 1]
MIDI_MSG_NEXT_AUTOLOOP_TAP_ON = [NOTE_ON, MIDI_NEXT_AUTOLOOP_CHANNEL, 1]
MIDI_MSG_NEXT_AUTOLOOP_TAP_OFF = [NOTE_OFF, MIDI_NEXT_AUTOLOOP_CHANNEL, 0]
