...
def classify_track(genres: List[str],
    ...
    if has_hip_hop_genres and not has_high_intensity_genres and not has_medium_intensity_genres:
    ...
    has_low_intensity_genres: bool = any(genre in genres_string for genre in LOW_INTENSITY_GENRES)
