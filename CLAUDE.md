...
| `nn/evaluate_v1.py` | decoded timelines + training table -> the val verdict at `<data-dir>/models/v1/eval_val.json`: NN and rule classifier side by side, scored by `evaluate_against_labels`' own functions |
