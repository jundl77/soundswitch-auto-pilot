...
1. kick_strength column: ≥ 2.0 in main groove (45–76 s) and final drop (128–158 s); ≤ 1.3 in intro (0–20 s) and breakdown (76.5–90 s). If not, revisit Task 2's `_KICK_CAPTURE_BUFFERS` (try 6–12) before touching thresholds.
